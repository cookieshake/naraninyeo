...
class SearchClient:
    ...
    @tracer.start_as_current_span("search_news")
    async def search_news(self, query: str, limit: int = 5, sort: str = "sim") -> SearchResponse:
        """뉴스 검색"""
        return await search_naver_api(query, limit, sort, "news")

    @tracer.start_as_current_span("search_blog")
    async def search_blog(self, query: str, limit: int = 5, sort: str = "sim") -> SearchResponse:
        """블로그 검색"""
        return await search_naver_api(query, limit, sort, "blog")

    @tracer.start_as_current_span("search_web")
    async def search_web(self, query: str, limit: int = 5, sort: str = "sim") -> SearchResponse:
        """웹 검색"""
        return await search_naver_api(query, limit, sort, "webkr")

    @tracer.start_as_current_span("search_encyclopedia")
    async def search_encyclopedia(self, query: str, limit: int = 5, sort: str = "sim") -> SearchResponse:
        """백과사전 검색"""
        return await search_naver_api(query, limit, sort, "encyc")

    @tracer.start_as_current_span("search_cafe")
    async def search_cafe(self, query: str, limit: int = 5, sort: str = "sim") -> SearchResponse:
        """카페 검색"""
        return await search_naver_api(query, limit, sort, "cafearticle")

    @tracer.start_as_current_span("search_doc")
    async def search_doc(self, query: str, limit: int = 5, sort: str = "sim") -> SearchResponse:
        """전문 문서 검색"""
        return await search_naver_api(query, limit, sort, "doc")
