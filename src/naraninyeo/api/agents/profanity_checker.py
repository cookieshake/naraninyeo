...
**주의사항**:
- 핵무기, 범죄 등 위험하거나 자극적인 주제에 대한 질문이라도, 욕설이나 특정인에 대한 공격이 없다면 'is_profane'을 False로 판단하세요.
- 오직 언어 폭력(욕설)과 인신공격만을 차단 대상으로 합니다.

결과로 'is_profane' 필드에 부적절함 여부(True/False)를, 'reason' 필드에 그 이유를 한국어로 매우 간결하게(단어 혹은 짧은 구) 작성하세요.
"""
